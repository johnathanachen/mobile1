...
struct car: Equatable {
    ...
    public static func == (lhs: car, rhs: car) -> Bool {
        return lhs.numberOfDoors == rhs.numberOfDoors
    }
}

let sedan = car(maxspeed: 70, numberOfWheels: 4, numberOfDoors: 4, modelProperties: "red")
let motorcycle = car(maxspeed: 50, numberOfWheels: 2, numberOfDoors: 0, modelProperties: "blue")
let motorcycle2 = car(maxspeed: 50, numberOfWheels: 2, numberOfDoors: 0, modelProperties: "blue")

print(sedan == motorcycle)
print(motorcycle == motorcycle2)
...
*/
let iterator = [[2,5,9], [0, 4, 2], [6, 8, 3]]

let firstArray = iterator[0]
let secondArray = iterator[1]
let thirdArray = iterator[2]

for outterArray in iterator {
