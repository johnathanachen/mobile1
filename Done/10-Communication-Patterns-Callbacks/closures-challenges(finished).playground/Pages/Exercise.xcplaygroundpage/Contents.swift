...
// 4
doesApply(a: 85436, b: 53893) { (a: Int, b: Int) -> Bool in
    return (a % 3) == 0 && (b % 3) == 0 ? true : false
}
// 5
doesApply(a: sumOfDigits(a: 47685), b: sumOfDigits(a: 344832)) {
    (a: Int, b: Int) -> Bool in return a == b ? true : false
}
// 6
func manipulateStrings(a: String, b: String, myFunction: (String, String) -> String?) -> String? {
    return myFunction(a, b)
}
// 7
...
manipulateStrings(a: "abcdef", b: "ghijkl", myFunction: concatenateSmallStrings)
