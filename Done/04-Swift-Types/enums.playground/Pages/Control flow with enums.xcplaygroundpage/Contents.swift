...
func getWeekdayName(week: Weekday) -> String {
    var dayName: String
    switch week {
        case .Monday: dayName = "Monday"
        case .Tuesday: dayName = "Tuesday"
        case .Wednesday: dayName = "Wednsday"
...
let seventhDay = Weekday.Sunday
print("This weekday is called \(Weekday.Sunday)")
print("This weekday is called \(seventhDay)")


func isItFinallyWeekend(week: Weekday) -> String {
    var dayName: String
    switch week {
        case .Monday, .Tuesday, .Wednesday, .Thursday, .Friday: dayName = "\(week) is a regular workday."
        case .Saturday, .Sunday: dayName = "Wuhuuuu, it's \(week)!"
    }
    return dayName
}

isItFinallyWeekend(week: .Monday)
isItFinallyWeekend(week: .Saturday)
